...
BBQ Age first-100, failures counted as wrong: classify-only 0.58, compare-then-choose 0.65, internal A/B/C **0.74**, A/B/C plus uncertainty veto **0.82** (ambiguous 0.90, disambiguated 0.74, p50 407 ms). Re-run `npm run eval -- bbq --limit 100` after prompt changes.
