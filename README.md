...
BBQ Age first-100, failures counted as wrong: classify-only 0.58, compare-then-choose 0.65, internal A/B/C prompt **0.74** (ambiguous 0.66, disambiguated 0.82, p50 386 ms). Re-run `npm run eval -- bbq --limit 100` after prompt changes.
