...
The chat roles follow [jev-single-decode](https://github.com/siren2345/jev-single-decode): session `instructions` hold `state`, and the user turn holds the questions.
...
| Local FM, system=`state` / user=questions | `left` | mixed | 32, max 8 | ~3.0–5.0 s |
